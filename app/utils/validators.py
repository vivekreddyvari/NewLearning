...
def validate_integer(
    ...
    """ Validates that arg_value is an integer, and optionally falls with specific bounds,
    ...
    Args:
        ...
        custom_max_message (str): optional, custome message when value is greater than maximum

    Returns:
        None: No exceptions raised if validation passes (validation is proper)
